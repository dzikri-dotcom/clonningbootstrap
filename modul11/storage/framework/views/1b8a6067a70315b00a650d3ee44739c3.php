    ...
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <div class="list-group mt-4">
                <a href="<?php echo e(url('/BootstrapKloning')); ?>" class="list-group-item list-group-item-action">
                    Tugas Kloningan Web Bootstrap
                </a>
            </div>
        ...
        <div class="list-group mt-4" >
            <a href="<?php echo e(url('route-list')); ?>" class="list-group-item list-group-item-action" style="color: red;">
                php artisan route:list</a>
        </div>

        <h6 class="mt-4">View Route List</h6>
        <div class="list-group mt-4" >
            <a href="<?php echo e(url('route-cache')); ?>" class="list-group-item list-group-item-action" style="color: red;">
                php artisan route:cache
            </a>
            <a href="<?php echo e(url('route-clear')); ?>" class="list-group-item list-group-item-action" style="color: red;">
...
<?php /**PATH C:\Users\Dzikri\OneDrive\Documents\SEMESTER 3\PAW\Laporan Praktikum 11\modul11\resources\views/routing.blade.php ENDPATH**/ ?>