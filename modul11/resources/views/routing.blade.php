    ...
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <div class="list-group mt-4">
                <a href="{{ url('/BootstrapKloning') }}" class="list-group-item list-group-item-action">
        ...
        <div class="list-group mt-4" >
            <a href="{{ url('route-list') }}" class="list-group-item list-group-item-action" style="color: red;">
                php artisan route:list</a>
        </div>

        <h6 class="mt-4">View Route List</h6>
        <div class="list-group mt-4" >
            <a href="{{ url('route-cache') }}" class="list-group-item list-group-item-action" style="color: red;">
                php artisan route:cache
            </a>
            <a href="{{ url('route-clear') }}" class="list-group-item list-group-item-action" style="color: red;">
